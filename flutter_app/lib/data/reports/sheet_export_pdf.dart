...
/// The PDF behind "Ekspor lembar ini": one sheet on an A4 landscape page.
/// Kept outside the screen so tests can build and inspect it.
class SheetExportPdf {
  const SheetExportPdf._();
        ...
        build: (pw.Context context) => <pw.Widget>[
          ...
          pw.Row(
            children: <pw.Widget>[
              ...
              pw.SizedBox(width: 8),
              _metricCard('Waspada 60-69°C', '$warning', PdfColors.orange700),
              pw.SizedBox(width: 8),
  ...
  static pw.Widget _reportHeader(ReportRow first, String filledBy) =>
      pw.Container(
        ...
        child: pw.Row(
          ...
          children: <pw.Widget>[
            ...
            pw.Column(
              ...
              children: <pw.Widget>[
                _headerInfo('TANGGAL', shownReportDate(first.date)),
  ...
  static pw.Widget _headerInfo(String label, String value) => pw.Padding(
  ...
  static pw.Widget _temperatureDistribution(
    List<_TemperatureValue> temperatures,
  ) {
  ...
  static List<_TemperatureValue> _temperatures(List<ReportRow> rows) => rows
  ...
  static List<List<String>> _equipmentBody(List<ReportRow> rows) {
  ...
  static List<List<String>> _gearboxBody(List<ReportRow> rows) {
