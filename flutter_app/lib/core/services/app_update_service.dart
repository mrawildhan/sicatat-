...
/// Reads the latest authenticated Android release and hands the APK to the
/// Android package installer. Android always asks the device owner to approve
/// an APK installation; the app never performs a silent update.
