...
| Audit tools (critical-temperature follow-up, check compliance, monthly report PDF, asset history, Tugas saya, backlog trend, budget charts, Excel exports) | `flutter_app/lib/features/daily_checks/{alert_follow_up,compliance}.dart`, `flutter_app/lib/features/reports/monthly_report.dart`, `flutter_app/lib/features/documents/presentation/asset_history_screen.dart`, `flutter_app/lib/core/export/xlsx_export.dart`, `flutter_app/lib/core/pdf/report_pdf.dart`, `supabase/migrations/20260926090000_alert_follow_up_and_backlog_history.sql` |
