...
begin
  ...
  insert into public.app_release (
    ...
    '2.8.21',
    12301,
    'arm64-v8a/app-arm64-v8a-2.8.21-release.apk',
    E'• PM kembali dikelompokkan per crew dan lokasi CPP/PORT.\n• Klik crew atau CM CPP/PORT untuk membuka daftar layar penuh.',
    true,
    release_creator
  );
end
