...
begin
  ...
  insert into public.app_release (
    ...
    '2.8.31',
    12311,
    'arm64-v8a/app-arm64-v8a-2.8.31-release.apk',
    E'• Data PR hanya tampil setelah dicari.
• Hasil dapat diurutkan berdasarkan tanggal barang datang terbaru atau terlama.
• Kartu dan detail PR menampilkan No. PO serta tanggal barang datang (Close Date).',
    true,
    release_creator
