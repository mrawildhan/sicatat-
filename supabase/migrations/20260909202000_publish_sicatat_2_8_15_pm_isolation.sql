...
begin
  ...
  insert into public.app_release (
    ...
    '2.8.15',
    12295,
    'arm64-v8a/app-arm64-v8a-2.8.15-release.apk',
    E'• Daftar PM tetap dapat dibuka saat sumber CM sedang diperiksa.\n• Detail work order PM dapat ditampilkan per crew dan lokasi.',
    true,
    release_creator
